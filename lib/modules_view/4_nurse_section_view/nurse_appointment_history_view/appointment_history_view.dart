...
import '../../../controllers/4_nurse_controller/nurse_appointment_controller/nurse_appointment_controller.dart';

class NurseeAppointmentHistory extends StatelessWidget {
  NurseeAppointmentHistory({Key? key}) : super(key: key);

  NurseAppointmentController _nurseappointmentdetailController =
      Get.put(NurseAppointmentController());
      ...
      child: Scaffold(
        ...
        body: Obx(
          () => (_nurseappointmentdetailController.isLoading.value)
              ...
              : _nurseappointmentdetailController.appointment == null
                  ? Center(
                      child: Text('No Data'),
                    )
                  : SafeArea(
