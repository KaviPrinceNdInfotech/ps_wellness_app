...
class ChemistProfileCredentials extends StatelessWidget {
  ...
  ChemistProfileController _chemistprofileController =
      Get.put(ChemistProfileController());
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: _chemistprofileController.chemistprofileformkey,
          ...
          children: [
            ...
            NeumorphicTextFieldContainer(
              child: TextFormField(
                ...
                controller: _chemistprofileController.mobileController,
                onSaved: (value) {
                  _chemistprofileController.mobile = value!;
                },
                validator: (value) {
                  return _chemistprofileController.validPhone(value!);
                },
                cursorColor: Colors.black,
                obscureText: false,
                decoration: InputDecoration(
            ...
            NeumorphicTextFieldContainer(
              child: TextFormField(
                ...
                controller: _chemistprofileController.nameController,
                onSaved: (value) {
                  _chemistprofileController.name = value!;
                },
                validator: (value) {
                  return _chemistprofileController.validName(value!);
                },
                cursorColor: Colors.black,
                obscureText: false,
                decoration: InputDecoration(
              ...
              child: Padding(
                ...
                child: Obx(
                  () => DropdownButtonFormField(
                      value: _chemistprofileController.selectedState.value,
                      decoration: InputDecoration(
                        prefixIcon: Icon(
                      ...
                      onChanged: (String? newValue) {
                        _chemistprofileController.selectedState.value =
                            newValue!;
              ...
              child: Padding(
                ...
                child: Obx(
                  () => DropdownButtonFormField(
                      ...
                      value: _chemistprofileController.selectedCity.value,
                      decoration: InputDecoration(
                        prefixIcon: Icon(
                          Icons.location_city,
                          color: Colors.black,
                      ...
                      onChanged: (String? newValue) {
                        _chemistprofileController.selectedCity.value =
                            newValue!;
                        // _hospital_2_controller.states.value =
                        //     newValue! as List<String>;
                        // _hospital_2_controller.selectedCity.value = null;
            ...
            NeumorphicTextFieldContainer(
              child: TextFormField(
                ...
                controller: _chemistprofileController.locatoionController,
                onSaved: (value) {
                  _chemistprofileController.location = value!;
                },
                validator: (value) {
                  return _chemistprofileController.validLocation(value!);
                },
                cursorColor: Colors.black,
                obscureText: false,
                decoration: InputDecoration(
            ...
            NeumorphicTextFieldContainer(
              child: TextFormField(
                controller: _chemistprofileController.feesController,
                onSaved: (value) {
                  _chemistprofileController.fees = value!;
                },
                validator: (value) {
                  return _chemistprofileController.validFees(value!);
                },
                cursorColor: Colors.black,
                obscureText: false,
                decoration: InputDecoration(
            ...
            NeumorphicTextFieldContainer(
              child: TextFormField(
                ...
                controller: _chemistprofileController.pinController,
                onSaved: (value) {
                  _chemistprofileController.pin = value!;
                },
                validator: (value) {
                  return _chemistprofileController.validPin(value!);
                },
                cursorColor: Colors.black,
                obscureText: false,
                decoration: InputDecoration(
