...
class HealthCheckupCredentials extends StatelessWidget {
  ...
  Health_checkup_1_Controller _health_checkup_1_controller =
      Get.put(Health_checkup_1_Controller());
  ...
  Widget build(BuildContext context) {
    ...
    return Form(
      key: _health_checkup_1_controller.healthcheckupform1key,
              ...
              child: Padding(
                ...
                child: Obx(
                  () => DropdownButtonFormField(
                      value: _health_checkup_1_controller.selectedState.value,
                      ...
                      onChanged: (String? newValue) {
                        _health_checkup_1_controller.selectedState.value =
                            newValue!;
              ...
              child: Padding(
                ...
                child: Obx(
                  () => DropdownButtonFormField(
                      ...
                      value: _health_checkup_1_controller.selectedCity.value,
                      decoration: InputDecoration(
                        prefixIcon: Icon(
                          Icons.location_city,
                          color: Colors.black,
                      ...
                      onChanged: (String? newValue) {
                        _health_checkup_1_controller.selectedCity.value =
                            newValue!;
                        // _hospital_2_controller.states.value =
                        //     newValue! as List<String>;
                        // _hospital_2_controller.selectedCity.value = null;
