...
class LabPaymentHistory extends StatelessWidget {
  ...
  LabpaymentController _labpaymentController = Get.put(LabpaymentController());
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage(
                              'lib/assets/user_assets/nurse_payment2.png',
                            ),
                            fit: BoxFit.cover)),
                  ),
                ),
                        ...
                        child: Theme(
                          ...
                          child: Obx(
                            () => (_labpaymentController.isLoading.value)
                                ...
                                : TextField(
                                    controller: _labpaymentController
                                        .appointmentController,
                                    onTap: () {
                                      _labpaymentController.chooseDate();
                                    },
                                    autofocus: false,
                                    style: TextStyle(
