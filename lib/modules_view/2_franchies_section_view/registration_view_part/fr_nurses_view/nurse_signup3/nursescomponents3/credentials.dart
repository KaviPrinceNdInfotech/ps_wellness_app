          ...
          children: [
            ...
            NeumorphicTextFieldContainer(
              child: TextFormField(
                ...
                controller: _frnurses_3_controller.dayController,
                onSaved: (value) {
                  _frnurses_3_controller.day = value!;
                },
                validator: (value) {
                  return _frnurses_3_controller.validDay(value!);
                },
            ...
            NeumorphicTextFieldContainer(
              child: TextFormField(
                ...
                controller: _frnurses_3_controller.locationController,
                onSaved: (value) {
                  _frnurses_3_controller.location = value!;
                },
                validator: (value) {
                  return _frnurses_3_controller.validLocation(value!);
                },
                cursorColor: Colors.black,
                obscureText: false,
                decoration: InputDecoration(
